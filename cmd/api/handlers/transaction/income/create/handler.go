// Package create handles POST /api/v1/transactions/incomes.
package create
...
// Handler handles POST /api/v1/transactions/incomes.
type Handler struct {
	uc useCase
}
...
// Handle processes POST /api/v1/transactions/incomes and returns 201 with the created transaction.
