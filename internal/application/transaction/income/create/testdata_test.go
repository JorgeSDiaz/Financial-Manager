...
// validIncome is the expected income transaction produced by a successful create.
var validIncome = domaintransaction.Transaction{
	ID:          fixedID,
	AccountID:   "acc-001",
	CategoryID:  "cat-001",
...
// errorIncome is the transaction passed to the repo when input is minimal.
var errorIncome = domaintransaction.Transaction{
	ID:        fixedID,
	AccountID: "acc-001",
	Type:      domaintransaction.TransactionTypeIncome,
	Amount:    100.0,
