// Package mocks contains testify mock implementations for the summary use case interfaces.
package mocks
...
// Repository is a testify mock for the summary.Repository interface.
